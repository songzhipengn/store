...
import random
from DButilsfu import update,query
print("===============================================")
print("|------------中国工商银行账户管理系统-------------|")
print("|------------------1、开户---------------------|")
print("|------------------2、存钱---------------------|")
...
def useradd():
    ...
    params = [username,account,password,country,province,street,door,money,'gs']
    update(sql,params)
    # if status ==3 :
    #     print("用户已满")
    # elif status== 2:
...
def makeenquiries():
    ...
    if accountnumber==a[0]["username"]:
        ...
        ------------个人信息------------
                    ...
                    当前账户的开户行：%s 
        '''
             print(info % (a[0]["username"],a[0]["account"],a[0]["password"],a[0]["username"],a[0]["username"],a[0]["username"],a[0]["username"],a[0]["username"],a[0]["username"]))
        else:
            print("密码错误！")
    else:
        print("用户名错误！")
